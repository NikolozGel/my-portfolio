...
export default function Home() {
  return (
    <>
      <section className="relative main xl:bg-[url(/assets/shared/bg-main-desktop.png)] bg-left bg-cover flex flex-col gap-5 bg-[#011627] border-x border-[#1e2d3d] p-4 rounded-b-lg border-b h-[86vh] overflow-hidden xl:pt-28 xl:pl-24">
        <motion.div
